...
- **Global scope**: `/home/z/my-project/BarakahBonds/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/z/my-project/BarakahBonds/.claude/notes/`)
...
2. Glob `/home/z/my-project/BarakahBonds/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/z/my-project/BarakahBonds/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/z/my-project/BarakahBonds/.claude/notes/` — works in any directory
