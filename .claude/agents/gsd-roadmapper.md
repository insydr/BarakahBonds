...
Reference full template: `/home/z/my-project/BarakahBonds/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/z/my-project/BarakahBonds/.claude/get-shit-done/templates/state.md`.
